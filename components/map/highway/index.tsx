...
const particleSize = [0.2, 0.6, 0.2];
const particleColor = 'rgba(250, 200, 200, 1)';
const animSpeed = 0.003;
const animPower = 0.004;
const animScale = 50;

const dataFile = '/data/highway.csv';
...
export function MapHighway({ mapScale }: { mapScale: number }) {
